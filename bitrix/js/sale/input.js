...
BX.Sale.Input = (function () {
	...
	DateInput.prototype.createEditorSingle = function (name, value)
	{
		 ...
		 */
		text.setAttribute('date-input', true);
		text.setAttribute('size', showTime ? '20' : '10');
		if (settings.DISABLED_DATES === 'Y')
			text.setAttribute('disabled-dates', true);
		if (settings.DISABLED_INPUT === 'Y')
		...
		Utils.addEventTo(button, 'click', function ()
		{
			BX.calendar({node:button, field:name, form:'', bTime:showTime, bHideTime:false});
			// TODO form
		});
