;(function () {
    ...
    SmithBonusengineEventTable = function() 
    {
    };


    SmithBonusengineEventTable.prototype = {
        ...
        {
            BX.ajax({  
                url: '/bitrix/tools/smith.bonusengine/delete_event_item.php',
                data: {
                    item_id: itemId
                },
                method: 'POST',
    ...
    BX.ready(function() {
        ...
        var EventTable = new SmithBonusengineEventTable();
