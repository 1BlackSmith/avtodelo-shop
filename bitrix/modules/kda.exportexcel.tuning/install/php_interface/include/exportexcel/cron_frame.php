...
$moduleRunnerClass = 'CKDAExportExcelRunnerTuning';
\Bitrix\Main\Loader::includeModule("iblock");
\Bitrix\Main\Loader::includeModule('catalog');
\Bitrix\Main\Loader::includeModule("currency");
\Bitrix\Main\Loader::includeModule($moduleId);
\Bitrix\Main\Loader::includeModule("kda.exportexcel.tuning");
...
foreach($arProfiles as $PROFILE_ID)
{
    ...
    $SETTINGS = array(
        'EXPORT_FILE_TO_EMAIL' => 'Y',
        'MAIL_TEMPLATE_EVENT' => 'KDA_EXPORT_SEND_FILE_TO_EMAIL',
        'PROFILE_NAME' => $arProfileFields['NAME'],
    );
