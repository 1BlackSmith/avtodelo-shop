...
class CSaleExport
{
	...
	static function getPayment($arOrder, $notExportPaymentsId = 0)
	{
		$result = array();
    ...
    static function ExportOrders2Xml($arFilter = Array(), $nTopCount = 0, $currency = "", $crmMode = false, $time_limit = 0, $version = false, $arOptions = Array(), $notExportPaymentsId = 0)
	{
		$lastOrderPrefix = '';
		$arCharSets = array();
