...
else
{
	...
	<div class="d-block">
		...
		{
			?>
			<a class="sale-order-history-link d-block" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y", $clearFromLink, false)?>">
		...
		{
			?>
			<a class="sale-order-history-link  d-block" href="<?=$APPLICATION->GetCurPageParam("", $clearFromLink, false)?>">
			...
			{
				?>
				<a class="sale-order-history-link  d-block" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y&show_canceled=Y", $clearFromLink, false)?>">
			...
			<div class="sale-order-list-container">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 sale-order-list-title-container">
						<h6 class="sale-order-list-title">
				...
				<div class="d-block">
					<div class="sale-order-list-inner-container">
						...
						foreach ($order['PAYMENT'] as $payment)
						{
							...
							<div class="row sale-order-list-inner-row ">
								...
								<div class="sale-order-list-inner-row-body">
									<div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-payment">
										<div class="sale-order-list-payment-title">
											...
											{
												?>
												<span class="sale-order-list-status-success alert-success"><?=Loc::getMessage('SPOL_TPL_PAID')?></span>
												<?
											}
											elseif ($order['ORDER']['IS_ALLOW_PAY'] == 'N')
											{
												?>
												<span class="sale-order-list-status-restricted alert-extra"><?=Loc::getMessage('SPOL_TPL_RESTRICTED_PAID')?></span>
												<?
											}
											else
											{
												?>
												<span class="sale-order-list-status-alert alert-danger"><?=Loc::getMessage('SPOL_TPL_NOTPAID')?></span>
												<?
											}
											?>
										</div>
									...
									if ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y')
									{
										if ($order['ORDER']['IS_ALLOW_PAY'] == 'N')
										{
											...
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button btn btn-primary disabled inactive-button">
										...
										elseif ($payment['NEW_WINDOW'] === 'Y')
										{
											?>
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button btn btn-primary" target="_blank" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>">
													<?=Loc::getMessage('SPOL_TPL_PAY')?>
												</a>
											</div>
											<?
										...
										else
										{
											?>
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button btn btn-primary ajax_reload" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>">
													<?=Loc::getMessage('SPOL_TPL_PAY')?>
												</a>
											</div>
											<?
								...
								<div class="col-lg-9 col-md-9 col-sm-10 col-xs-12 sale-order-list-inner-row-template">
									<a href="#" class="sale-order-list-cancel-payment btn btn-outline-primary">
							...
							<div class="row sale-order-list-inner-row">
								...
								<div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-shipment">
									...
									<span class="sale-order-list-shipment-element">
										...
										{
											?>
											<span class="sale-order-list-status-success alert-success"><?=Loc::getMessage('SPOL_TPL_LOADED');?></span>
											<?
										}
										else
										{
											?>
											<span class="sale-order-list-status-alert alert-danger"><?=Loc::getMessage('SPOL_TPL_NOTLOADED');?></span>
											<?
										}
										?>
									</div>
									...
									<div class="sale-order-list-shipment-status">
										...
										<span class="sale-order-list-shipment-status-block alert-extra"><?=htmlspecialcharsbx($shipment['DELIVERY_STATUS_NAME'])?></span>
									</div>
						...
						?>
						<div class="sale-order-list-top-border"></div>
						<div class=" sale-order-list-inner-row sale-order-list-inner-row-buttons-container">
							<div class="sale-order-list-inner-button sale-order-list-inner-button--about">
								<a class="sale-order-list-about-link btn btn-primary" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>"><?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></a>
							</div>
							<div class="sale-order-list-inner-button sale-order-list-inner-button--repeat">
								<a class="sale-order-list-repeat-link btn btn-primary" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>"><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></a>
							</div>
							<div class="sale-order-list-inner-button sale-order-list-inner-button--cancel">
								<a class="sale-order-list-cancel-link btn btn-primary" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_CANCEL"])?>"><?=Loc::getMessage('SPOL_TPL_CANCEL_ORDER')?></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="sale-order-list-container">
					...
					<div class="col-md-12 col-sm-12">
						<div class="row no-gutters">
							<div class="col-md-8 col-sm-12 sale-order-list-accomplished-title-container">
								<h6 class="sale-order-list-accomplished-title">
									<?= Loc::getMessage('SPOL_TPL_ORDER') ?>
				...
				<div class="row">
					<div class="col-md-12 sale-order-list-inner-accomplished">
						<div class="d-flex justify-content-between sale-order-list-inner-row">
							<div class="sale-order-list-about-accomplished">
								<a class="sale-order-list-about-link btn btn-primary" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>">
									<?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?>
								</a>
							</div>
							<div class="sale-order-list-repeat-accomplished">
								<a class="sale-order-list-repeat-link sale-order-link-accomplished btn btn-primary" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
