		...
		<div class="simple-basket-total__buttons">
			<div class="d-flex justify-content-between align-items-center">
				...
				<div class="text-right">
					<a href="<?=SITE_DIR?>buy1click/?RS_ORDER_IDS=<?=implode(",", $arResult['BASKET_ITEMS_ID']);?>" data-type="ajax" class="btn btn-outline-secondary">	<?=Loc::getMessage('SBB_BUY1CLICK')?></a>
					<a href="<?=$arParams['PATH_TO_ORDER']?>" class="btn btn-primary"><?=Loc::getMessage('SBB_ORDER')?></a>
				</div>
			</div>
		</div>
	</div>
