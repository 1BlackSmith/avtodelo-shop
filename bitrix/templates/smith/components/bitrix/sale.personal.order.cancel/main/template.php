...
<div class="row">
	<div class="col col-md-6">
		<a class="mb-5" href="<?=$arResult["URL_TO_LIST"]?>"><?=GetMessage("SALE_RECORDS_LIST")?></a>
		...
		<div class="bx_my_order_cancel">
			<?if(strlen($arResult["ERROR_MESSAGE"])<=0):?>
				<form method="post" action="<?=POST_FORM_ACTION_URI?>">
					...
					<input type="submit" class="btn btn-primary" name="action" value="<?=GetMessage("SALE_CANCEL_ORDER_BTN") ?>">
