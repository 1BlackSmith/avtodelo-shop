...
// Разграничение показа баннеров на разных сайтах
// if (!function_exists('banners_filter')) {
// 	function banners_filter($section) 
// 	{
// 		return in_array(SITE_ID, $section['PROPERTIES']['SITE']['VALUE_XML_ID']);
// 	}
// }
// $arResult["ITEMS"] = array_filter($arResult["ITEMS"], "banners_filter");