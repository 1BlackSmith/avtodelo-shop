...
if ($arParams['SINGLE_COMPONENT'] == "Y")
	...
	echo '<div class="bx_item_detail_inc_two text-nowrap" id="'.$blockID.'">';
...
foreach ($arResult["BRAND_BLOCKS"] as $blockId => $arBB)
{
	...
	?><div id="<?=$brandID;?>" class="brandblock-container text-center px-5 d-inline-block"<?// echo ($usePopup ? ' data-popup="'.$popupID.'"' : ''); ?>>
		<?
		if ($useLink)
		{
