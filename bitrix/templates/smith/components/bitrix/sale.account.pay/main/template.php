	...
	if ($arParams['REFRESHED_COMPONENT_MODE'] === 'Y')
	{
		...
		<div class="bx-sap" id="bx-sap<?=$wrapperId?>">
			<div class="d-block">
							...
							<div class="col-xs-12 sale-acountpay-block">
								...
								<div class="sale-acountpay-fixedpay-container">
									<div class="sale-acountpay-fixedpay-list">
										...
										{
											?>
											<div class="sale-acountpay-fixedpay-item btn btn-outline-primary">
				...
				<div class="row">
					<div class="col-xs-12">
						<a href="" class="btn btn-primary btn-rounded sale-account-pay-button"><?=Loc::getMessage("SAP_BUTTON")?></a>
					</div>
				</div>
			</div>
		</div>
