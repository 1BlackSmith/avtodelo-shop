...
else
{
	...
	if ($isFilter)
	{
		...
		<div class="bg-light py-4 px-2 d-block mb-1 d-md-none">
			<a class="btn btn-outline-secondary w-100" data-fancybox="catalog-filter" data-touch="false" href="#<?=$arParams['AJAX_ID']?>-filter"><?=Loc::getMessage('RS_MM_BC_CATALOG_FILTER_SHOW')?></a>
		</div>
		<?php
	}
	...
	$componentSectionParams = array(
		...
		"BY_LINK" => "Y", // set smart.filter + INCLUDE_SUBSECTIONS=Y = bug
