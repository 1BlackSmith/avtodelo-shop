...
*/
	...
	<div class="product-light-container w-100" id="<?=$areaId?>" data-entity="item">
			...
			*/
				...
				<div class="col-9 col-lg-8 pl-0">
					...
					<div class="product-light-info-container product-light-price-container" data-entity="price-block">
						...
						<span class="product-light-price-current<?=($price['RATIO_PRICE'] < $price['RATIO_BASE_PRICE'] ? ' discount' : '')?>" id="<?=$itemIds['PRICE']?>">
							<?
							if (!empty($price))
							{
		...
		<article class="product-light h-100">
			<div class="row">
				<div class="col-3 col-lg-4">
					<a class="product-light-image-wrapper" href="javascript:void(0);" title="" data-entity="image-wrapper">
						<img class="product-light-image lazy-anim-img" data-lazy-img="" data-src="" src="/bitrix/templates/smith/assets/images/empty/1_1.png">
					</a>
				</div>
				<div class="col-9 col-lg-8 pl-0">
					<div style="display: inline-block; width: 170px; height: 16px; background-color: #fefefe; margin-bottom: 15px;"></div>
					<div style="display: inline-block; width: 120px; height: 16px; background-color: #fefefe; margin-bottom: 10px;"></div>
					<div class="product-light-info-container product-light-price-container" data-entity="price-block">
						<span style="display: inline-block; width: 70px; height: 24px; background-color: #fefefe;"></span>
					</div>
				</div>
			</div>
		</article>
