...
// $arPrices = $arResult['CAT_PRICES'];
// $basePriceId = null;
// foreach ($arPrices as $arPrice) {
// 	if ($arPrice['BASE'] == 'Y') {
// 		$basePriceId = $arPrice['ID'];
// 		break;
// 	}
// }

// $arAllPrices = $arResult['ITEM_ALL_PRICES'];
...
\Bitrix\Main\IO\File::putFileContents($_SERVER['DOCUMENT_ROOT'] . '/log.txt', print_r($arResult, true));
...
// 		$price['PRICE_BONUS'] = BasketTable::roundPrecision($price['PRICE'] * $bonus / 100);
// 		$price['PRINT_RATIO_BONUS'] = CurrencyFormat($price['PRICE_BONUS'], 'RUB');

// 		$arParams['SHOW_CASHBACK'] = 'Y';
// 	}
// } unset($pricesCount); unset($price);
