...
<article class="bx-catalog-element" id="<?=$itemIds['ID']?>" itemscope itemtype="http://schema.org/Product">
	...
	<div class="product-detail">
		<div class="row">
			...
			<div class="col-xs-12 col-lg-5">
				<div class="product-detail-slider-container" id="<?=$itemIds['BIG_SLIDER_ID']?>">
					...
					switch ($blockName)
					{
						...
						case 'price':
							...
							<div class="mb-6">
								...
								// 	{
								// 		include(MyTemplate::getTemplatePart($templateFolder.'/include/info/price_old.php'));
								// 	}
								...
								include(MyTemplate::getTemplatePart($templateFolder.'/include/info/price_my.php'));
								include(MyTemplate::getTemplatePart($templateFolder.'/include/info/price-bonus_my.php'));

								if ($pricesCount > 2): ?>
									<div class="pt-2">
										<div class="mb-3">
											<a href="#prices" class="font-size-m collapsed" data-toggle="collapse" aria-expanded="true" aria-controls="prices">
										...
										<div class="collapse" id="prices">
											<div class="mb-1">
												<? include(MyTemplate::getTemplatePart($templateFolder.'/include/info/price-ranges_my.php')); ?>
											</div>
										</div>
									</div>
								<? endif; ?>
								...
								<div class="mb-6" id="<?=$itemIds['TREE_ID']?>">
									...
									foreach ($arResult['SKU_PROPS'] as $skuProperty)
									{
										...
										<div data-entity="sku-line-block">
											<div class="mb-2 small text-extra"><?=htmlspecialcharsEx($skuProperty['NAME'])?>: <span class="text-body" data-entity="sku-current-value"></span></div>
	...
	$layoutHeader->defineShowFn(function () use ($arResult, $arParams) {
		?>
		<div class="nav-wrap">
			...
			switch ($blockName)
			{
				...
				case 'props':
					...
					if ($showDisplayProperties)
					{
						...
						$layout
							...
							->addModifier('outer-spacing')
							->addModifier('inner-spacing')
							->addData('SECTION_ATTRIBUTES', ' id="'.$mainId.'_'.$blockName.'" data-spy="item" data-target="#l-main__nav" data-title="'.$arParams['MESS_PROPERTIES_TAB'].'"');
				...
				case 'stock':
					if ($arParams['USE_STORE'] == 'Y' && $arResult['MODULES']['catalog'])
					{
						...
						$layoutHeader = new \Redsign\MegaMart\Layouts\Parts\SectionHeaderBase();
						$layoutHeader->addData('TITLE', $arParams['STOCK_MAIN_TITLE']);
						...
						$layout
							...
							->addModifier('shadow')
							->addModifier('outer-spacing')
							->addData('SECTION_ATTRIBUTES', ' id="'.$mainId.'_'.$blockName.'" data-spy="item" data-target="#l-main__nav" data-title="'.$arParams['STOCK_MAIN_TITLE'].'"');
