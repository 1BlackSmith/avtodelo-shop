...
if (!empty($arResult['RECOMMENDED_IDS']))
{
	...
	if (empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] !== 'Y')
	{
		...
		<div class="bx_item_list_title">
			<?=GetMessage('CATALOG_RECOMMENDED_PRODUCTS_HREF_TITLE')?>
		</div>
		<?
	}
	...
	$APPLICATION->IncludeComponent(
		...
		array(
            ...
            'SHOW_PARENT_TITLE' => !isset($arParams['SHOW_PARENT_TITLE']) || $arParams['SHOW_PARENT_TITLE'] !== 'N' ? 'Y' : 'N',
            'PARENT_TITLE' => $arParams['PARENT_TITLE'] ?: Loc::getMessage('CT_BCE_CATALOG_GIFT_BLOCK_TITLE_DEFAULT'),

            'RS_LIST_SECTION' => 'l_section',
			'RS_LIST_SECTION_SHOW_TITLE' => 'Y',
			'RS_LIST_SECTION_TITLE' => GetMessage('CATALOG_RECOMMENDED_PRODUCTS_HREF_TITLE'),
		),
		$component,
		array('HIDE_ICONS' => 'Y')
	);
