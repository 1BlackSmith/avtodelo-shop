...
<div class="contacts-view">
	...
	<div class="contacts-view">
		<div class="contacts-view__map">
			<?php $APPLICATION->IncludeComponent("bitrix:map.yandex.system", ".default", Array(
					"COMPONENT_TEMPLATE" => ".default",
					"KEY" => "1151b4f9-f176-43e9-903c-bed9603594be",
					"INIT_MAP_TYPE" => "MAP",	// Стартовый тип карты
					"INIT_MAP_LON" => 36.102514,
					"INIT_MAP_LAT" => 52.977300,
					"INIT_MAP_SCALE" => 17,
					...
					"MAP_ID" => "contacts",	// Идентификатор карты
					"API_KEY" => "1151b4f9-f176-43e9-903c-bed9603594be",	// Ключ API
		...
		<div class="contacts-view__content">
			<?$APPLICATION->IncludeComponent(
				...
				array(
					"AREA_FILE_SHOW" => "file",
					"TEMPLATE" => 'line',
					"PATH" => SITE_DIR."/include/templates/contacts/map.php",
					"EDIT_TEMPLATE" => ""
				),
				false
			);?>
