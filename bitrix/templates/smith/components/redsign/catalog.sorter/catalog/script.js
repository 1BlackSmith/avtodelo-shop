(function (window){
	...
	if (window.RSCatalogSorter) return;
	...
	window.RSCatalogSorter.prototype = {
		init: function()
		{
			...
			this.items = BX.findChildren(this.obSorter, itemsFilter, true);
			if (this.items.length > 0) {
				BX.bindDelegate(this.obSorter, 'click', itemsFilter, BX.proxy(this.catalogRefresh, this));
			}
