...
<div>
	...
	{
		?>
		<div class="alert alert-success" role="alert"><?=$arResult['GOOD_ORDER_TEXT']?></div>
		<div class="text-center">
			<button class="btn btn-primary" onclick="$.fancybox.close();"><?=Loc::getMessage('MSG_CONTINUE')?></button>
		</div>
		<?php
		$jsParams = array();
