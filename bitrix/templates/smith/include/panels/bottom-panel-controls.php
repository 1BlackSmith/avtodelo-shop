	...
	<div class="d-flex justify-content-between">
		...
		<div class="d-flex">
			...
			if (isset($RS_FAVORITE_DATA)) {
				...
				?><a href="<?=$sPathToFavorite?>" class="c-button-control bottom-panel-control js-global-favorite<?=($RS_FAVORITE_DATA['COUNT'] > 0 ? ' has-items' : '')?>"<?
					if ($isAjax) {
				...
				$frame->beginStub();
				?><a href="<?=$sPathToFavorite?>" class="c-button-control bottom-panel-control js-global-favorite">
					<span class="c-button-control__icon">
						<svg class="icon-svg"><use xlink:href="#svg-heart"></use></svg>
			...
			if (isset($RS_COMPARE_DATA)) {
				...
				$frame->begin();
				?><a href="<?=$sCompareUrl?>" class="c-button-control bottom-panel-control js-global-compare<?=($RS_COMPARE_DATA['COUNT'] > 0 ? ' has-items' : '')?>" data-type="bottom-control">
					<span class="c-button-control__icon">
				...
				$frame->beginStub();
				?><a href="<?=$sCompareUrl?>" class="c-button-control bottom-panel-control js-global-compare">
					<span class="c-button-control__icon">
						<svg class="icon-svg"><use xlink:href="#svg-copy"></use></svg>
			...
			if (isset($RS_BASKET_DATA)) {
				...
				$frame->begin();
				?><a href="<?=$sPathToCart?>" class="c-button-control bottom-panel-control js-global-cart<?=($RS_BASKET_DATA['NUM_PRODUCTS'] > 0 ? ' has-items' : '')?>"<?
					if ($isAjax) {
				...
				$frame->beginStub();
				?><a href="<?=$sPathToCart?>" class="c-button-control bottom-panel-control js-global-cart">
					<span class="c-button-control__icon">
						<svg class="icon-svg"><use xlink:href="#svg-cart"></use></svg>
