...
<footer class="l-footer l-footer--<?=RS_MM_FOOTER_THEME?>" data-footer>
	...
	<div class="l-footer__inner">
		<div class="container">
          ...
          <div class="mb-4">
						...
						<tbody>
						<tr>
							<td class="text-primary small">Название компании</td>
							<td class="text-primary small">ИП Потапов Дмитрий Николаевич</td>
						</tr>
						<tr>
							<td class="text-primary small"> ОГРНИП</td>
							<td class="text-primary small">316574900080433</td>
						</tr>
						<tr>
							<td class="text-primary small" colspan="1"> ИНН</td>
							<td class="text-primary small" colspan="1"> 575403534210</td>
						</tr>
						<tr>
							<td class="text-primary small"> Юридический адрес</td>
							<td class="text-primary small"> 302006, г.Орел, ул. Московская, д. 102</td>
						</tr>
						</tbody>
						</table>
					</div>
		...
		<div class="container">
			<div class="d-flex justify-content-between align-items-center">
				<div class="d-block">
					...
					<div class="d-block b-offer">
                        Обращаясь на наш сайт, вы даете
                        <a target="_blank" href="/info/agreement">согласие на обработку</a>
				...
				<div class="d-flex align-items-center">
					...
					<?php
					$APPLICATION->IncludeFile(
						SITE_DIR.'/include/footer/metrica.php',
						array(),
						array()
					);
					?>
