...
*/
		...
		updateCashback: function(price)
		{
			var obPriceRow = this.getEntities(this.obProduct, 'price')[0],
			...
			if (obPriceCurrent)
			{
				if (obPriceCashBack)
				{
					if (price.RATIO_BONUS > 0)
					{
						...
						this.getEntity(obPriceCashBack, 'cashback-value').innerHTML = (price.PRICE_BONUS_ROUNDED * this.obQuantity.value).toFixed(1);
					}
					else
					{
