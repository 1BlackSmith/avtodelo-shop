...
{
	?>
	<div class="product-cat-artnumber mb-2" data-entity="sku-prop-<?=$actualItem['PROPERTIES'][$arParams['ARTNUMBER_PROP'][$actualItem['IBLOCK_ID']]]['ID']?>">
		<?php
		echo str_replace(
			'#NUMBER#',
...
{
	?>
	<div class="product-cat-artnumber mb-2">
		<?php
		echo str_replace(
			'#NUMBER#',
