		...
		<div class="sale-order-detail-general">
				...
				<div class="sale-order-detail-about-order-container">
					...
					<div class="d-block">
						<div class="sale-order-detail-about-order-inner-container">
							<div class="row">
								<div class="col-sm sale-order-detail-about-order-inner-container-name">
								...
								<div class="col-sm sale-order-detail-about-order-inner-container-status">
								...
								<div class="col-sm sale-order-detail-about-order-inner-container-price">
								...
								{
									?>
									<div class="col-sm sale-order-detail-about-order-inner-container-repeat">
										<a href="<?=$arResult["URL_TO_COPY"]?>" class="sale-order-detail-about-order-inner-container-repeat-button btn btn-primary">
							...
							<div class="col-sm sale-order-detail-about-order-inner-container-details">
												...
												<div class="row sale-order-detail-payment-options-methods-information-block">
													...
													<div class="col-md-8 col-sm-7 col-xs-10 sale-order-detail-payment-options-methods-info">
														<div class="sale-order-detail-payment-options-methods-info-title">
															<div class="sale-order-detail-methods-title">
																...
																{
																	?>
																	<span class="sale-order-detail-payment-options-methods-info-title-status-success alert-success">
																...
																{
																	?>
																	<span class="sale-order-detail-payment-options-methods-info-title-status-restricted alert-extra">
																...
																{
																	?>
																	<span class="sale-order-detail-payment-options-methods-info-title-status-alert alert-danger">
													...
													if ($payment['PAY_SYSTEM']["IS_CASH"] !== "Y")
													{
														...
														<div class="col-md-2 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods-button-container">
															...
															{
																?>
																<a class="btn-theme sale-order-detail-payment-options-methods-button-element-new-window btn btn-primary"
																   target="_blank"
															...
															else
															{
																...
																{
																	?>
																	<a href="#" onclick="event.preventDefault();" class="btn-theme sale-order-detail-payment-options-methods-button-element inactive-button btn btn-primary" disabled><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																	<?
																}
																else
																{
																	?>
																	<a href="#" onclick="event.preventDefault();" class="btn-theme sale-order-detail-payment-options-methods-button-element active-button btn btn-primary"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																	<?
																}
															}
															?>
											...
											<div class="col-md-12 col-md-12 col-sm-12 sale-order-detail-payment-options-shipment-container">
												<div class="row">
													<div class="col-md-12 col-md-12 col-sm-12 sale-order-detail-payment-options-shipment">
														...
														<div class="col-md-9 offset-md-3 col-sm-12 sale-order-detail-payment-options-shipment-composition-map">
															<?
			...
			<div class="sale-order-detail-total-payment">
				<div class="sale-order-detail-total-payment-container">
					<div class="row">
						<ul class="col-md-3 offset-md-6 col sale-order-detail-total-payment-list-left">
							...
							if ($arResult['DEDUCTED_POINTS'] > 0) {
							?>
								<li class="sale-order-detail-total-payment-list-left-item"><?= Loc::getMessage('SPOD_DEDUCTED_POINTS') ?>:</li>
							<? }

							if ($arResult['AWARDED_POINTS'] > 0) {
							?>
								<li class="sale-order-detail-total-payment-list-left-item"><?= Loc::getMessage('SPOD_AWARDED_POINTS') ?>:</li>
							<? } ?>

							<li class="sale-order-detail-total-payment-list-left-item"><?= Loc::getMessage('SPOD_SUMMARY')?>:</li>
						</ul>
						<ul class="col-md-3 col sale-order-detail-total-payment-list-right">
							<?
							if (floatval($arResult["ORDER_WEIGHT"])) { ?>
							...
							if ($arResult['DEDUCTED_POINTS'] > 0) { ?>
								<li class="sale-order-detail-total-payment-list-right-item"><?= $arResult["DEDUCTED_POINTS"] ?></li>
							<? }

							if ($arResult['AWARDED_POINTS'] > 0) { ?>
								<li class="sale-order-detail-total-payment-list-right-item"><?= $arResult["AWARDED_POINTS"] ?></li>
							<? } ?>
