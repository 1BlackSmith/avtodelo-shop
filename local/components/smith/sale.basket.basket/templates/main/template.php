...
$layout->start();
?>		
		<? if ($arResult['SBB_FREE_DELIVERY_OFFER']) { ?>
			<div class="alert alert-success">
				<div class="row">
					<div class="col-xs-12" style="position: relative; padding-left: 48px;">
						<div class="icon-success"></div>
						<div><?= Loc::getMessage('SBB_FREE_DELIVERY_OFFER') ?></div>
					</div>
				</div>
			</div>
		<? } ?>
		<? if ($arResult['SBB_FREE_DELIVERY']) { ?>
			<div class="alert alert-success">
				<div class="row">
					<div class="col-xs-12" style="position: relative; padding-left: 48px;">
						<div class="icon-success"></div>
						<div><?= Loc::getMessage('SBB_FREE_DELIVERY') ?></div>
					</div>
				</div>
			</div>
		<? } ?>
