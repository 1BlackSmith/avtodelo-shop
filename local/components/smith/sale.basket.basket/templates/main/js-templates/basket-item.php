...
$usePriceInAdditionalColumn = in_array('PRICE', $arParams['COLUMNS_LIST']);
...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}{{#SHOW_LOADING}} is-loading{{/SHOW_LOADING}}"
		...
		{{^SHOW_RESTORE}}
											...
											{{#SKU_BLOCK_LIST}}
												{{#IS_IMAGE}}
													<div class="basket-item-property basket-item-property-scu-image"
														...
														<div class="basket-item-property-name">
															<span class="basket-item-property-name-title">{{NAME}}</span>
															<span class="basket-item-property-name-value">{{{SELECT_VALUE}}}</span>
														</div>
														<div class="basket-item-property-value">
																...
																{{#SKU_VALUES_LIST}}
																	<li class="basket-item-scu-item{{#SELECTED}} selected{{/SELECTED}}
																		...
																		data-property="{{PROP_CODE}}">
																			<span class="basket-item-scu-item-block">
												...
												{{^IS_IMAGE}}
													<div class="basket-item-property basket-item-property-scu-text"
														...
														<div class="basket-item-property-value">
															<?php if ($arParams['DISPLAY_MODE'] == 'compact'): ?>
																<ul class="basket-item-scu-list">
																	{{#SKU_VALUES_LIST}}
																		<li class="basket-item-scu-item{{#SELECTED}} selected{{/SELECTED}}
																			{{#NOT_AVAILABLE_OFFER}} not-available{{/NOT_AVAILABLE_OFFER}}"
															...
															<?php else: ?>
																<div class="dropdown position-static">
																	<a class="btn btn-outline-secondary dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-boundary="window">
																		{{SELECT_VALUE}}
																	</a>

																	<div class="dropdown-menu" x-placement="bottom-start">
																		{{#SKU_VALUES_LIST}}
																			<a class="dropdown-item{{#NOT_AVAILABLE_OFFER}} disabled{{/NOT_AVAILABLE_OFFER}}" title="{{NAME}}"
																				data-entity="basket-item-sku-field"
																				data-initial="{{#SELECTED}}true{{/SELECTED}}{{^SELECTED}}false{{/SELECTED}}"
																				data-value-id="{{VALUE_ID}}"
																				data-sku-name="{{NAME}}"
															...
															<?php /* <ul class="basket-item-scu-list">
																{{#SKU_VALUES_LIST}}
																	<li class="basket-item-scu-item{{#SELECTED}} selected{{/SELECTED}}
																		{{#NOT_AVAILABLE_OFFER}} not-available{{/NOT_AVAILABLE_OFFER}}"
																		title="{{NAME}}"
												...
												{{#IS_IMAGE}}
													<div class="basket-item-property-custom basket-item-property-custom-photo
														...
														<div class="basket-item-property-custom-value">
															{{#VALUE}}
																<a href="{{{IMAGE_SRC_ORIGINAL}}}" data-fancybox="image_{{ID}}">
			...
			<td class="basket-items-list-item-amount">
				<div class="basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
					...
					<span class="basket-item-amount-btn-minus" data-entity="basket-item-quantity-minus"></span>
						<div class="basket-item-amount-field-block">
							<div class="input-group d-inline-flex flex-nowrap w-auto">
								<input type="text" class="form-control basket-item-amount-field" value="{{QUANTITY}}"
									{{#NOT_AVAILABLE}} disabled="disabled"{{/NOT_AVAILABLE}}
									data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field"
									id="basket-item-quantity-{{ID}}">
								<span class="basket-item-amount-measure-text input-group-append">
			...
			{
				?>
				<td class="basket-items-list-item-price basket-items-list-item-price-for-one d-none d-sm-table-cell">
					<div class="basket-item-block-price">
						<?php /** {{#SHOW_DISCOUNT_PRICE}}
						...
						<div class="basket-item-price-current">
							<div class="text-extra small d-lg-none"><?=Loc::getMessage('SBB_TABLE_TH_PRICE')?></div>
				...
				<!-- <td class="basket-items-list-item-price d-none d-sm-table-cell">
					{{#SHOW_DISCOUNT_PRICE}}
						<div class="basket-item-block-price basket-item-block-price-aligner">
							<div class="basket-item-price-old">
								<div class="text-extra small d-lg-none"><?=Loc::getMessage('SBB_TABLE_TH_DISCOUNT')?></div>
								<span class="basket-item-price-old-text">
			...
			if ($useSumColumn)
			{
				...
				<td class="basket-items-list-item-price">
					<div class="basket-item-block-price basket-item-block-price-aligner">
						<div class="basket-item-price-current">
							<div class="text-extra small d-lg-none"><?=Loc::getMessage('SBB_TABLE_TH_SUM')?></div>
			...
			if ($useActionColumn)
			{
				...
				<td class="basket-items-list-item-remove hidden-xs">
					<div class="basket-item-block-actions">
						...
						<!-- <svg class="icon-svg basket-item-actions-remove" data-entity="basket-item-delete"><use xlink:href="#svg-trash"></use></svg> -->
						{{#SHOW_LOADING}}
							<div class="basket-items-list-item-overlay"></div>
						{{/SHOW_LOADING}}
					</div>
