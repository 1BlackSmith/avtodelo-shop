;(function(){
	...
	BX.Sale.BasketActionPool.prototype.calculateBonuses = function(checked)
	{
		if (checked) {
			this.pool.BONUSES_RECALCULATION = 'Y';
		} else {
			this.pool.BONUSES_RECALCULATION = 'N';
		}

		this.switchTimer();
	};

	BX.Sale.BasketActionPool.prototype.selectClient = function(clientId)
	{
		this.pool.CLIENT_ID = clientId;
		this.switchTimer();
	};
	...
	BX.Sale.BasketActionPool.prototype.getPoolData = function()
	{
		...
		if (currentPool.BONUSES_RECALCULATION)
		{
			poolData.bonuses_recalculation = currentPool.BONUSES_RECALCULATION;
			delete currentPool.BONUSES_RECALCULATION;
		}

		if (currentPool.CLIENT_ID)
		{
			poolData.client_select = currentPool.CLIENT_ID;
			delete currentPool.CLIENT_ID;
		}
