...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(		
		...
		"PATH_TO_B2B_ACCOUNT" => array(
			"NAME" => GetMessage("SPS_PATH_TO_B2B_ACCOUNT"),
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "/personal/b2b/",
			"COLS" => 25,
			"PARENT" => "URL_TEMPLATES",
		),
		"PATH_TO_B2B_CLIENTS" => array(
			"NAME" => GetMessage("SPS_PATH_TO_B2B_CLIENTS"),
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "/personal/clients/",
			"COLS" => 25,
			"PARENT" => "URL_TEMPLATES",
		),
