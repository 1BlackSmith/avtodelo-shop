...
if ($arResult['SHOW_B2B_ACCOUNT'] === 'Y')
{
	$availablePages[] = array(
		"path" => $arParams['PATH_TO_B2B_ACCOUNT'],
		"name" => Loc::getMessage("SPS_B2B_ACCOUNT"),
		"icon" => 'lk-contacts'
	);
}
...
{
	$availablePages[] = array(
		"path" => $arParams['PATH_TO_B2B_CLIENTS'],
		"name" => Loc::getMessage("SPS_B2B_CLIENTS"),
		"icon" => 'lk-contacts'
	);
}
